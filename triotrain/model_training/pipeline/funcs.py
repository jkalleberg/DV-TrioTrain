...
class Setup:
    ...
    def find_show_regions_file(self):
        ...
        """
        regions = h.TestFile(self.args.show_regions_file, self.logger)
    ...
    def start_iteration(
        ...
        """
        no_current_deps = h.check_if_all_same(self.current_genome_deps, None)
        no_updated_deps = h.check_if_all_same(current_deps, None)
        no_next_deps = h.check_if_all_same(self.next_genome_deps, None)
        no_new_next_deps = h.check_if_all_same(next_deps, None)
    ...
    def end_iteration(self) -> None:
        ...
        """
        print(
            f"============================================================\nEnd of Iteration {self.meta.itr_num}-of-{self.meta.num_of_iterations} @ {h.timestamp()}\nCURRENT DEPS: {self.current_genome_deps}\nNEXT DEPS: {self.next_genome_deps}\n============================================================"
        )
